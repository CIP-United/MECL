...
/**
  ...
  @par
                   ...
                   <code>pState</code> is of length <code>numTaps+blockSize-1</code> samples, where <code>blockSize</code> is the number of input samples processed by each call to <code>mips_fir_q7()</code>.
        ...
        uint32_t blockSize)
{
  ...
  memset(pState, 0, (numTaps + (blockSize - 1U)) * sizeof(q7));
