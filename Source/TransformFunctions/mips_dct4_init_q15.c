  ...
  q15 normalize)
{
  ...
  switch (N)
  {
  #if !defined(MIPS_DSP_CONFIG_TABLES) || defined(MIPS_ALL_FFT_TABLES) || defined(MIPS_TABLE_DCT4_Q15_8192)
  ...
  #if !defined(MIPS_DSP_CONFIG_TABLES) || defined(MIPS_ALL_FFT_TABLES) || defined(MIPS_TABLE_DCT4_Q15_2048)
  case 2048U:
  ...
  #if !defined(MIPS_DSP_CONFIG_TABLES) || defined(MIPS_ALL_FFT_TABLES) || defined(MIPS_TABLE_DCT4_Q15_512)
  case 512U:
  ...
  #if !defined(MIPS_DSP_CONFIG_TABLES) || defined(MIPS_ALL_FFT_TABLES) || defined(MIPS_TABLE_DCT4_Q15_128)
  case 128U:
  ...
  mips_rfft_init_q15(S->pRfft, S->N, 0U, 1U);
