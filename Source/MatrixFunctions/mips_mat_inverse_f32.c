...
/**
  ...
  Matrix inversion is numerically sensitive and the MIPS Embedded Compute Library only supports matrix
        ...
        mips_matrix_instance_f32 * pDst)
{
  ...
  f32 pivot = 0.0f, newPivot=0.0f;                /* Temporary input values  */
