 ...
 * Title:        mips_cfft_radix2_init_q15.c
...
/**
  ...
  @deprecated                   Do not use this function. It has been superseded by \ref mips_cfft_q15 and will be removed
  ...
  uint8_t bitReverseFlag)
{
...
#if !defined(MIPS_DSP_CONFIG_TABLES) || defined(MIPS_ALL_FFT_TABLES) || defined(MIPS_TABLE_TWIDDLECOEF_Q15_4096)
  ...
  S->pTwiddle = (q15 *) twiddleCoef_4096_q15;
  /*  Initialise the Flag for selection of CFFT or CIFFT */
  S->ifftFlag = ifftFlag;
  /*  Initialise the Flag for calculation Bit reversal or not */
  S->bitReverseFlag = bitReverseFlag;

#if !defined(MIPS_DSP_CONFIG_TABLES) || defined(MIPS_ALL_FFT_TABLES) || defined(MIPS_TABLE_BITREV_1024)
