 ...
 * Title:        mips_fir_interpolate_init_f32.c
...
/**
  ...
  @par
                   ...
                   where <code>blockSize</code> is the number of input samples processed by each call to <code>mips_fir_interpolate_f32()</code>.
 */
        ...
        uint32_t blockSize)
{
  ...
  else
  {
    ...
    memset(pState, 0, (blockSize + ((uint32_t) S->phaseLength - 1U)) * sizeof(f32));
