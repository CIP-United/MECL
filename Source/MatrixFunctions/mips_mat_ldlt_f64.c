...
mips_status mips_mat_ldlt_f64(
  ...
  mips_matrix_instance_f64 * pl,
  mips_matrix_instance_f64 * pd,
  uint16_t * pp)
{
...

  {
    ...
    memset(pd->pData,0,sizeof(f64)*n*n);

    memcpy(pl->pData,pSrc->pData,n*n*sizeof(f64));
    pA = pl->pData;
