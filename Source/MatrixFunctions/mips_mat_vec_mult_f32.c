...
void mips_mat_vec_mult_f32(const mips_matrix_instance_f32 *pSrcMat, const f32 *pVec, f32 *pDst)
{
    uint32_t numRows = pSrcMat->numRows;
    uint32_t numCols = pSrcMat->numCols;
    const f32 *pSrcA = pSrcMat->pData;
    const f32 *pInA1;      /* input data matrix pointer A of Q31 type */
    const f32 *pInA2;      /* input data matrix pointer A of Q31 type */
    const f32 *pInA3;      /* input data matrix pointer A of Q31 type */
    const f32 *pInA4;      /* input data matrix pointer A of Q31 type */
    const f32 *pInVec;     /* input data matrix pointer B of Q31 type */
    f32 *px;               /* Temporary output data matrix pointer */
    uint16_t i, row, colCnt; /* loop counters */
    f32 matData, matData2, vecData, vecData2;
