 ...
 * Title:        mips_fir_decimate_fast_q15.c
...
/**
  ...
  @remark
                   Refer to \ref mips_fir_decimate_q15() for a slower implementation of this function which uses 64-bit accumulation to avoid wrap around distortion.
                   Both the slow and the fast versions use the same instance structure.
                   Use function \ref mips_fir_decimate_init_q15() to initialize the filter structure.
 */
