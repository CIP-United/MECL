...
mips_status mips_mat_trans_q7(const mips_matrix_instance_q7 *pSrc, mips_matrix_instance_q7 *pDst)
{
    q7 *pSrcA = pSrc->pData;         /* input data matrix pointer */
