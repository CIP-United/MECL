 ...
 * Title:        mips_biquad_cascade_df2T_init_f32.c
...
/**
  ...
  @par
                   ...
                   mips_biquad_cascade_df2T_compute_coefs_f32 which is taking the
  ...
  <pre>
                   mips_biquad_cascade_df2T_compute_coefs_f32(nbCascade,coefs,computedCoefs);
                   mips_biquad_cascade_df2T_init_f32(&SNeon, nbCascade, computedCoefs, stateNeon);
  </pre>
        ...
        f32 * pState)
{
  ...
  memset(pState, 0, (2U * (uint32_t) numStages) * sizeof(f32));
