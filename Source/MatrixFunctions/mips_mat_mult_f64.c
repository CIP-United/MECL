...
{
  f64 *pIn1 = pSrcA->pData;                /* Input data matrix pointer A */
  f64 *pIn2 = pSrcB->pData;                /* Input data matrix pointer B */
  ...
  f64 *px;                                 /* Temporary output data matrix pointer */
  f64 sum;                                 /* Accumulator */
