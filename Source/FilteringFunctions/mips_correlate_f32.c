...
/**
  ...
  The MECL provides correlation functions for Q7, Q15, Q31 and floating-point data types.
...
/* alternate version for CM0_FAMILY */
  ...
  const f32 *pIn2 = pSrcB + (srcBLen - 1U);      /* inputB pointer */
        f32 sum;                                 /* Accumulator */
