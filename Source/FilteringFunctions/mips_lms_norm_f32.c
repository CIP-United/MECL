...
/**
  ...
  The MIPS Embedded Compute Library contains normalized LMS filter functions that operate on Q15, Q31, and floating-point data types.
        ...
        uint32_t blockSize)
{
        ...
        f32 energy;                              /* Energy of the input */
        f32 x0, in;                              /* Temporary variable to hold input sample and state */
