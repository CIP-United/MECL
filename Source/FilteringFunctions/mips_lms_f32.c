...
/**
  ...
  The MIPS Embedded Compute Library contains LMS filter functions that operate on Q15, Q31, and floating-point data types.
  ...
  <pre>
     mips_lms_instance_f32 S = {numTaps, pState, pCoeffs, mu};
     mips_lms_instance_q31 S = {numTaps, pState, pCoeffs, mu, postShift};
     mips_lms_instance_q15 S = {numTaps, pState, pCoeffs, mu, postShift};
  </pre>
...
{       
        ...
        f32 *pCoeffs = S->pCoeffs;               /* Coefficient pointer */
        f32 *pStateCurnt;                        /* Points to the current sample of the state */
        f32 *px, *pb;                            /* Temporary pointers for state and coefficient buffers */
        f32 mu = S->mu;                          /* Adaptive factor */
        f32 acc, e;                              /* Accumulator, error */
        f32 w;                                   /* Weight factor */
