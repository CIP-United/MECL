...
#ifndef _MIPS_UTILS_HELIUM_H_
#define _MIPS_UTILS_HELIUM_H_
...
__STATIC_FORCEINLINE f32 vecAddAcrossF32Msa(v4f32 in)
{
    f32 acc;

    acc = msa_getq_lane_f32(in, 0) + msa_getq_lane_f32(in, 1) +
          msa_getq_lane_f32(in, 2) + msa_getq_lane_f32(in, 3);
