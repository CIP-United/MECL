...
/**
  ...
  The float implementation is relying on mips_var_f32 which is using a two-pass algorithm
...
{
  f32 var;
  mips_var_f32(pSrc,blockSize,&var);
  mips_sqrt_f32(var, pResult);
}
