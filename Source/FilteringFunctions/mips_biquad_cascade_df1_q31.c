 ...
 * Title:        mips_biquad_cascade_df1_q31.c
...
/**
  ...
  @remark
                   Refer to \ref mips_biquad_cascade_df1_fast_q31() for a faster but less precise implementation of this filter.
 */
        ...
        uint32_t blockSize)
{
  ...
  const q31 *pCoeffs = S->pCoeffs;                   /* Coefficient pointer */
        ...
        q31 acc_l, acc_h;                            /* temporary output variables */
#endif
  ...
  do
  {
    ...
    while (sample > 0U)
    {
      ...
      /* acc =  b0 * x[n] + b1 * x[n-1] + b2 * x[n-2] + a1 * y[n-1] + a2 * y[n-2] */
      acc = ((q63) b0 * Xn) + ((q63) b1 * Xn1) + ((q63) b2 * Xn2) + ((q63) a1 * Yn1) + ((q63) a2 * Yn2);
      ...
      *pOut++ = Yn2;
      ...
      /* acc =  b0 * x[n] + b1 * x[n-1] + b2 * x[n-2] + a1 * y[n-1] + a2 * y[n-2] */
      acc = ((q63) b0 * Xn2) + ((q63) b1 * Xn) + ((q63) b2 * Xn1) + ((q63) a1 * Yn2) + ((q63) a2 * Yn1);
      ...
      *pOut++ = Yn1;
      ...
      /* acc =  b0 * x[n] + b1 * x[n-1] + b2 * x[n-2] + a1 * y[n-1] + a2 * y[n-2] */
      acc = ((q63) b0 * Xn1) + ((q63) b1 * Xn2) + ((q63) b2 * Xn) + ((q63) a1 * Yn1) + ((q63) a2 * Yn2);
      ...
      *pOut++ = Yn2;
      ...
      /* acc =  b0 * x[n] + b1 * x[n-1] + b2 * x[n-2] + a1 * y[n-1] + a2 * y[n-2] */
      acc = ((q63) b0 * Xn) + ((q63) b1 * Xn1) + ((q63) b2 * Xn2) + ((q63) a1 * Yn2) + ((q63) a2 * Yn1);
