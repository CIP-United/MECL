...
/**
  ...
  If the requested subset does not fall in this range then the functions return MIPS_MATH_ARGUMENT_ERROR.
  Otherwise the functions return MIPS_MATH_SUCCESS.
  \note Refer to \ref mips_conv_f32() for details on fixed point behavior.
...
/* alternate version for CM0_FAMILY */
  ...
  const f32 *pIn1 = pSrcA;                       /* InputA pointer */
  const f32 *pIn2 = pSrcB;                       /* InputB pointer */
        f32 sum;                                 /* Accumulator */
