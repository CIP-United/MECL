 ...
 */
 ...
 /**
   ...
   *
   */
  void mips_blackman_harris_92db_f64(
        f64 * pDst,
        uint32_t blockSize);
 ...
 /**
   ...
   *
   */
  void mips_blackman_harris_92db_f32(
        f32 * pDst,
        uint32_t blockSize);
 /**
