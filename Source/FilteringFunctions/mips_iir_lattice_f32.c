...
/**
  ...
  <pre>
      mips_iir_lattice_instance_f32 S = {numStages, pState, pkCoeffs, pvCoeffs};
      mips_iir_lattice_instance_q31 S = {numStages, pState, pkCoeffs, pvCoeffs};
      mips_iir_lattice_instance_q15 S = {numStages, pState, pkCoeffs, pvCoeffs};
  </pre>
  @par
...
{       
        ...
        f32 *pStateCur;                            /* State current pointer */
        f32 acc;                                   /* Accumlator */
        f32 fnext1, fnext2, gcurr1, gnext;         /* Temporary variables for lattice stages */
        f32 *px1, *px2, *pk, *pv;                  /* Temporary pointers for state and coef */
        uint32_t numStages = S->numStages;               /* Number of stages */
        uint32_t blkCnt, tapCnt;                         /* Temporary variables for counts */

#if defined (MIPS_MATH_LOOPUNROLL)
        f32 gcurr2;                                /* Temporary variables for lattice stages */
        f32 k1, k2;
        f32 v1, v2, v3, v4;
#endif
