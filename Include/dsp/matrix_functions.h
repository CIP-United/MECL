 ...
 *       f32 *pData;     // points to the data of the matrix.
 *     } mips_matrix_instance_f32;
 * </pre>
 ...
 * Refer to \ref mips_mat_init_f32(), \ref mips_mat_init_q31() and \ref mips_mat_init_q15()
 ...
 * <pre>
 * <code>mips_matrix_instance_f32 S = {nRows, nColumns, pData};</code>
 * <code>mips_matrix_instance_q31 S = {nRows, nColumns, pData};</code>
 * <code>mips_matrix_instance_q15 S = {nRows, nColumns, pData};</code>
 * </pre>
 ...
 * <pre>
 *     MIPS_MATH_MATRIX_CHECK
 * </pre>
 * within the library project settings.  By default this macro is defined
 * and size checking is enabled. By changing the project settings and
 * undefining this macro size checking is eliminated and the functions
 * run a bit faster. With size checking disabled the functions always
 * return <code>MIPS_MATH_SUCCESS</code>.
 */
 ...
 /**
  ...
  typedef struct
  {
    uint16_t numRows;     /**< number of rows of the matrix.     */
    uint16_t numCols;     /**< number of columns of the matrix.  */
    f64 *pData;     /**< points to the data of the matrix. */
  } mips_matrix_instance_f64;
 ...
 /**
  ...
  typedef struct
  {
    uint16_t numRows;     /**< number of rows of the matrix.     */
    uint16_t numCols;     /**< number of columns of the matrix.  */
    q7 *pData;         /**< points to the data of the matrix. */
  } mips_matrix_instance_q7;
  ...
  typedef struct
  {
    uint16_t numRows;     /**< number of rows of the matrix.     */
    uint16_t numCols;     /**< number of columns of the matrix.  */
    q15 *pData;         /**< points to the data of the matrix. */
  } mips_matrix_instance_q15;
  ...
  typedef struct
  {
    uint16_t numRows;     /**< number of rows of the matrix.     */
    uint16_t numCols;     /**< number of columns of the matrix.  */
    q31 *pData;         /**< points to the data of the matrix. */
  } mips_matrix_instance_q31;
...
mips_status mips_mat_add_q31(
   ...
   * <code>MIPS_MATH_SIZE_MISMATCH</code> or <code>MIPS_MATH_SUCCESS</code> based on the outcome of size checking.
   */
mips_status mips_mat_cmplx_mult_f32(
  const mips_matrix_instance_f32 * pSrcA,
  const mips_matrix_instance_f32 * pSrcB,
        mips_matrix_instance_f32 * pDst);
...
mips_status mips_mat_cmplx_mult_q31(
   ...
   * @return    The function returns either  <code>MIPS_MATH_SIZE_MISMATCH</code>
   * or <code>MIPS_MATH_SUCCESS</code> based on the outcome of size checking.
   */
mips_status mips_mat_trans_f32(
...
/**
   ...
   * or <code>MIPS_MATH_SUCCESS</code> based on the outcome of size checking.
   */
mips_status mips_mat_trans_f64(
  const mips_matrix_instance_f64 * pSrc,
   ...
   * or <code>MIPS_MATH_SUCCESS</code> based on the outcome of size checking.
   */
mips_status mips_mat_cmplx_trans_f32(
  const mips_matrix_instance_f32 * pSrc,
  mips_matrix_instance_f32 * pDst);
   ...
   * or <code>MIPS_MATH_SUCCESS</code> based on the outcome of size checking.
   */
mips_status mips_mat_trans_q15(
...
mips_status mips_mat_cmplx_trans_q15(
   ...
   * or <code>MIPS_MATH_SUCCESS</code> based on the outcome of size checking.
   */
mips_status mips_mat_trans_q7(
  const mips_matrix_instance_q7 * pSrc,
        mips_matrix_instance_q7 * pDst);
   ...
   * or <code>MIPS_MATH_SUCCESS</code> based on the outcome of size checking.
   */
mips_status mips_mat_trans_q31(
...
mips_status mips_mat_mult_f64(
   ...
   */
void mips_mat_vec_mult_f32(
  const mips_matrix_instance_f32 *pSrcMat, 
  const f32 *pVec, 
  f32 *pDst);
   ...
   * <code>MIPS_MATH_SIZE_MISMATCH</code> or <code>MIPS_MATH_SUCCESS</code> based on the outcome of size checking.
   */
mips_status mips_mat_mult_q7(
  const mips_matrix_instance_q7 * pSrcA,
  const mips_matrix_instance_q7 * pSrcB,
        mips_matrix_instance_q7 * pDst,
        q7 * pState);
   ...
   * @param[out] pDst     points to output vector
   */
void mips_mat_vec_mult_q7(
  const mips_matrix_instance_q7 *pSrcMat, 
  const q7 *pVec, 
  q7 *pDst);
...
mips_status mips_mat_mult_q15(
   ...
   * @param[out] pDst     points to output vector
   */
void mips_mat_vec_mult_q15(
  const mips_matrix_instance_q15 *pSrcMat, 
  const q15 *pVec, 
  q15 *pDst);
...
mips_status mips_mat_mult_q31(
   ...
   * <code>MIPS_MATH_SIZE_MISMATCH</code> or <code>MIPS_MATH_SUCCESS</code> based on the outcome of size checking.
   */
mips_status mips_mat_mult_opt_q31(
  const mips_matrix_instance_q31 * pSrcA,
  const mips_matrix_instance_q31 * pSrcB,
        mips_matrix_instance_q31 * pDst,
        q31 *pState);
   ...
   * @param[out] pDst     points to output vector
   */
void mips_mat_vec_mult_q31(
  const mips_matrix_instance_q31 *pSrcMat, 
  const q31 *pVec, 
  q31 *pDst);
...
void mips_mat_init_q31(
   ...
   * @param[in]     pData     points to the matrix data array.
   */
void mips_mat_init_q15(
        mips_matrix_instance_q15 * S,
        uint16_t nRows,
        uint16_t nColumns,
        q15 * pData);
 ...
 * @param[in]     pData     points to the matrix data array.
 */
void mips_mat_init_f64(
      mips_matrix_instance_f64 * S,
      uint16_t nRows,
      uint16_t nColumns,
      f64 * pData);
   ...
   * If the input matrix is singular (does not have an inverse), then the algorithm terminates and returns error status MIPS_MATH_SINGULAR.
   */
  mips_status mips_mat_inverse_f32(
  const mips_matrix_instance_f32 * src,
  mips_matrix_instance_f32 * dst);
   ...
   * If the input matrix is singular (does not have an inverse), then the algorithm terminates and returns error status MIPS_MATH_SINGULAR.
   */
  mips_status mips_mat_inverse_f64(
  const mips_matrix_instance_f64 * src,
 ...
 /**
   ...
   * @param[out] dst   points to the instance of the output floating-point matrix structure.
   * @return The function returns MIPS_MATH_SIZE_MISMATCH, if the dimensions do not match.
   * If the input matrix does not have a decomposition, then the algorithm terminates and returns error status MIPS_MATH_DECOMPOSITION_FAILURE.
   * If the matrix is ill conditioned or only semi-definite, then it is better using the LDL^t decomposition.
   * The decomposition is returning a lower triangular matrix.
   */
  mips_status mips_mat_cholesky_f64(
  const mips_matrix_instance_f64 * src,
  mips_matrix_instance_f64 * dst);
 ...
 /**
   ...
   * The decomposition is returning a lower triangular matrix.
   */
  mips_status mips_mat_cholesky_f32(
  const mips_matrix_instance_f32 * src,
  mips_matrix_instance_f32 * dst);
  ...
  */
  mips_status mips_mat_solve_upper_triangular_f32(
  const mips_matrix_instance_f32 * ut,
  const mips_matrix_instance_f32 * a,
  mips_matrix_instance_f32 * dst);
 ...
 /**
   ...
   * @return The function returns MIPS_MATH_SINGULAR, if the system can't be solved.
   */
  mips_status mips_mat_solve_lower_triangular_f32(
  const mips_matrix_instance_f32 * lt,
  const mips_matrix_instance_f32 * a,
  mips_matrix_instance_f32 * dst);
 ...
 /**
  ...
  const mips_matrix_instance_f32 * src,
  mips_matrix_instance_f32 * l,
  mips_matrix_instance_f32 * d,
  uint16_t * pp);
 ...
 /**
   ...
   * The decomposition is returning a lower triangular matrix.
   */
  mips_status mips_mat_ldlt_f64(
  const mips_matrix_instance_f64 * src,
  mips_matrix_instance_f64 * l,
  mips_matrix_instance_f64 * d,
  uint16_t * pp);
...
/**
  ...
  @return        execution status
                   ...
                   - \ref MIPS_MATH_SINGULAR      : Input matrix is found to be singular (non-invertible)
 */
...
mips_status mips_mat_qr_f64(
    const mips_matrix_instance_f64 * pSrc,
    const f64 threshold,
    mips_matrix_instance_f64 * pOutR,
    mips_matrix_instance_f64 * pOutQ,
    f64 * pOutTau,
    f64 *pTmpA,
    f64 *pTmpB
    );
