        ...
        uint32_t blockSize)
{
  ...
  const q15 *pCoeffs = S->pCoeffs;                   /* Coefficient pointer */
        q15 *px;                                     /* Temporary state pointer */
  const q15 *pk;                                     /* Temporary coefficient pointer */
        uint32_t numStages = S->numStages;             /* Number of stages in the filter */
        uint32_t blkCnt, stageCnt;                     /* Loop counters */
        q31 fcurr0, fnext0, gnext0, gcurr0;          /* Temporary variables */

#if (1)
//#if !defined(MIPS_MATH_CM0_FAMILY)

#if defined (MIPS_MATH_LOOPUNROLL)
  q31 fcurr1, fnext1, gnext1;                  /* Temporary variables for second sample in loop unrolling */
  q31 fcurr2, fnext2, gnext2;                  /* Temporary variables for third sample in loop unrolling */
  q31 fcurr3, fnext3, gnext3;                  /* Temporary variables for fourth sample in loop unrolling */
#endif
  ...
  while (blkCnt > 0U)
  {
    ...
    /* f1(n) = f0(n) +  K1 * g0(n-1) */
    fnext0 = (q31) ((gcurr0 * (*pk)) >> 15U) + fcurr0;
    fnext0 = __SSAT(fnext0, 16);

    /* g1(n) = f0(n) * K1  +  g0(n-1) */
    gnext0 = (q31) ((fcurr0 * (*pk)) >> 15U) + gcurr0;
    gnext0 = __SSAT(gnext0, 16);

    /* Process second sample for first tap */
    fnext1 = (q31) ((fcurr0 * (*pk)) >> 15U) + fcurr1;
    fnext1 = __SSAT(fnext1, 16);
    gnext1 = (q31) ((fcurr1 * (*pk)) >> 15U) + fcurr0;
    ...
    fnext2 = (q31) ((fcurr1 * (*pk)) >> 15U) + fcurr2;
    fnext2 = __SSAT(fnext2, 16);
    gnext2 = (q31) ((fcurr2 * (*pk)) >> 15U) + fcurr1;
    gnext2 = __SSAT(gnext2, 16);

    /* Process fourth sample for first tap */
    fnext3 = (q31) ((fcurr2 * (*pk  )) >> 15U) + fcurr3;
    fnext3 = __SSAT(fnext3, 16);
    gnext3 = (q31) ((fcurr3 * (*pk++)) >> 15U) + fcurr2;
    ...
    *px++ = (q15) fcurr3;
    ...
    while (stageCnt > 0U)
    {
      ...
      *px++ = (q15) gnext3;
      ...
      fnext1 = (q31) ((gnext0 * (*pk)) >> 15U) + fcurr1;
      fnext1 = __SSAT(fnext1, 16);

      /* Process third sample for 2nd, 6th .. tap */
      fnext2 = (q31) ((gnext1 * (*pk)) >> 15U) + fcurr2;
      fnext2 = __SSAT(fnext2, 16);

      /* Process fourth sample for 2nd, 6th .. tap */
      fnext3 = (q31) ((gnext2 * (*pk)) >> 15U) + fcurr3;
      fnext3 = __SSAT(fnext3, 16);

      /* g1(n) = f0(n) * K1  +  g0(n-1) */
      /* Calculation of state values for next stage */
      gnext3 = (q31) ((fcurr3 * (*pk)) >> 15U) + gnext2;
      gnext3 = __SSAT(gnext3, 16);

      gnext2 = (q31) ((fcurr2 * (*pk)) >> 15U) + gnext1;
      gnext2 = __SSAT(gnext2, 16);

      gnext1 = (q31) ((fcurr1 * (*pk)) >> 15U) + gnext0;
      gnext1 = __SSAT(gnext1, 16);
      ...
      *px++ = (q15) gnext3;
      ...
      /* f3(n) = f2(n) +  K3 * g2(n-1) */
      fcurr0 = (q31) ((gcurr0 * (*pk)) >> 15U) + fnext0;
      fcurr0 = __SSAT(fcurr0, 16);

      /* Process second sample for 3rd, 7th .. tap */
      fcurr1 = (q31) ((gnext0 * (*pk)) >> 15U) + fnext1;
      fcurr1 = __SSAT(fcurr1, 16);

      /* Process third sample for 3rd, 7th .. tap */
      fcurr2 = (q31) ((gnext1 * (*pk)) >> 15U) + fnext2;
      fcurr2 = __SSAT(fcurr2, 16);

      /* Process fourth sample for 3rd, 7th .. tap */
      fcurr3 = (q31) ((gnext2 * (*pk)) >> 15U) + fnext3;
      fcurr3 = __SSAT(fcurr3, 16);

      /* Calculation of state values for next stage */
      /* g3(n) = f2(n) * K3  +  g2(n-1) */
      gnext3 = (q31) ((fnext3 * (*pk)) >> 15U) + gnext2;
      gnext3 = __SSAT(gnext3, 16);

      gnext2 = (q31) ((fnext2 * (*pk)) >> 15U) + gnext1;
      gnext2 = __SSAT(gnext2, 16);

      gnext1 = (q31) ((fnext1 * (*pk)) >> 15U) + gnext0;
      gnext1 = __SSAT(gnext1, 16);

      gnext0 = (q31) ((fnext0 * (*pk++)) >> 15U) + gcurr0;
      gnext0 = __SSAT(gnext0, 16);
