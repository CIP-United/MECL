 ...
 */
 ...
 /**
   ...
   * @param[in]  numSamples  number of complex samples in the input vector
   */
  void mips_cmplx_mag_squared_f64(
  const f64 * pSrc,
        f64 * pDst,
        uint32_t numSamples);
...
/**
   ...
   * @param[in]  numSamples  number of complex samples in each vector
   */
  void mips_cmplx_mult_cmplx_f32(
  const f32 * pSrcA,
  const f32 * pSrcB,
        f32 * pDst,
        uint32_t numSamples);
 ...
 * @param[in]  numSamples  number of complex samples in each vector
 */
void mips_cmplx_mult_cmplx_f64(
const f64 * pSrcA,
const f64 * pSrcB,
	  f64 * pDst,
	  uint32_t numSamples);
