 ...
 * Title:        mips_fir_sparse_init_q31.c
...
/**
  ...
  @par           Details
                   ...
                   <code>blockSize</code> is the number of words processed by <code>mips_fir_sparse_q31()</code> function.
 */
        ...
        uint32_t blockSize)
{
  ...
  memset(pState, 0, (maxDelay + blockSize) * sizeof(q31));
