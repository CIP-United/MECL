...
/**
  ...
  The FIR decimator functions provided in the MIPS Embedded Compute Library combine the FIR filter and the decimator in an efficient manner.
 ...
 @par            Initialization Functions
  ...
  <pre>
      mips_fir_decimate_instance_f32 S = {M, numTaps, pCoeffs, pState};
      mips_fir_decimate_instance_q31 S = {M, numTaps, pCoeffs, pState};
      mips_fir_decimate_instance_q15 S = {M, numTaps, pCoeffs, pState};
  </pre>
        ...
        uint32_t blockSize)
{
  ...
  const f32 *pCoeffs = S->pCoeffs;               /* Coefficient pointer */
        ...
        f32 *px0;                                /* Temporary pointer for state buffer */
  const f32 *pb;                                 /* Temporary pointer for coefficient buffer */
        f32 x0, c0;                              /* Temporary variables to hold state and coefficient values */
