...
/**
  ...
  <pre>
      mips_fir_lattice_instance_f32 S = {numStages, pState, pCoeffs};
      mips_fir_lattice_instance_q31 S = {numStages, pState, pCoeffs};
      mips_fir_lattice_instance_q15 S = {numStages, pState, pCoeffs};
  </pre>
  @par
        ...
        uint32_t blockSize)
{
  ...
  const f32 *pCoeffs = S->pCoeffs;               /* Coefficient pointer */
        f32 *px;                                 /* Temporary state pointer */
  const f32 *pk;                                 /* Temporary coefficient pointer */
        uint32_t numStages = S->numStages;             /* Number of stages in the filter */
        uint32_t blkCnt, stageCnt;                     /* Loop counters */
        f32 fcurr0, fnext0, gnext0, gcurr0;      /* Temporary variables */

#if defined (MIPS_MATH_LOOPUNROLL)
        f32 fcurr1, fnext1, gnext1;              /* Temporary variables for second sample in loop unrolling */
        f32 fcurr2, fnext2, gnext2;              /* Temporary variables for third sample in loop unrolling */
        f32 fcurr3, fnext3, gnext3;              /* Temporary variables for fourth sample in loop unrolling */
#endif
