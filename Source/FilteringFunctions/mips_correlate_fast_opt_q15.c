 ...
 * Title:        mips_correlate_fast_opt_q15.c
        ...
        q15 * pScratch)
{
  ...
  const q15 *pIn2;                                   /* InputB pointer */
        ...
        q15 *pScr1 = pScratch;                       /* Temporary pointer for scratch */
  const q15 *py;                                     /* Intermediate inputB pointer */
        ...
        q31 x1, x2, x3;                              /* Temporary variables for holding input and coefficient values */
