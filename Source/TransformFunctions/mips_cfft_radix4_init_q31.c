 ...
 * Title:        mips_cfft_radix4_init_q31.c
  ...
  uint8_t bitReverseFlag)
{
...
#if !defined(MIPS_DSP_CONFIG_TABLES) || defined(MIPS_ALL_FFT_TABLES) || defined(MIPS_TABLE_TWIDDLECOEF_Q31_4096)
  ...
  S->pTwiddle = (q31 *) twiddleCoef_4096_q31;
