 ...
 *
 * Licensed under the Apache License, VersionS 2.0 (the License); you may
...
/**
  ...
  @remark
                   Refer to \ref mips_fir_fast_q15() for a faster but less precise implementation of this function.
 */
void mips_fir_q15(
