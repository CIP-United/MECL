 ...
 * Title:        mips_lms_norm_init_q31.c
...
/**
  ...
  <pre>
     {b[numTaps-1], b[numTaps-2], b[N-2], ..., b[1], b[0]}
                   ...
                   where <code>blockSize</code> is the number of input samples processed by each call to <code>mips_lms_norm_q31()</code>.
 */
        ...
        uint8_t postShift)
{
  ...
  S->recipTable = (q31 *) mipsRecipTableQ31;
