...
f32 mips_euclidean_distance_f32(const f32 *pA,const f32 *pB, uint32_t blockSize);
 ...
 *
 */
f32 mips_correlation_distance_f32(f32 *pA,f32 *pB, uint32_t blockSize);
...
f32 mips_dice_distance(const uint32_t *pA, const uint32_t *pB, uint32_t numberOfBools);
...
f32 mips_hamming_distance(const uint32_t *pA, const uint32_t *pB, uint32_t numberOfBools);
...
f32 mips_jaccard_distance(const uint32_t *pA, const uint32_t *pB, uint32_t numberOfBools);
...
f32 mips_kulsinski_distance(const uint32_t *pA, const uint32_t *pB, uint32_t numberOfBools);
...
f32 mips_rogerstanimoto_distance(const uint32_t *pA, const uint32_t *pB, uint32_t numberOfBools);
...
f32 mips_russellrao_distance(const uint32_t *pA, const uint32_t *pB, uint32_t numberOfBools);
...
f32 mips_sokalmichener_distance(const uint32_t *pA, const uint32_t *pB, uint32_t numberOfBools);
...
f32 mips_sokalsneath_distance(const uint32_t *pA, const uint32_t *pB, uint32_t numberOfBools);
...
f32 mips_yule_distance(const uint32_t *pA, const uint32_t *pB, uint32_t numberOfBools);

typedef enum
  {
    MIPS_DTW_SAKOE_CHIBA_WINDOW = 1,
    /*MIPS_DTW_ITAKURA_WINDOW = 2,*/
    MIPS_DTW_SLANTED_BAND_WINDOW = 3
  } mips_dtw_window;
...
mips_status mips_dtw_distance_f32(const mips_matrix_instance_f32 *pDistance,
                               const mips_matrix_instance_q7 *pWindow,
                               mips_matrix_instance_f32 *pDTW,
                               f32 *distance);
...
void mips_dtw_path_f32(const mips_matrix_instance_f32 *pDTW,
                      int16_t *pPath,
                      uint32_t *pathLength);
#ifdef   __cplusplus
}
