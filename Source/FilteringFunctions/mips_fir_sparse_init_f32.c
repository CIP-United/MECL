 ...
 * Title:        mips_fir_sparse_init_f32.c
...
/**
  ...
  @par           Details
                   ...
                   number of samples processed by the <code>mips_fir_sparse_f32()</code> function.
 */
        ...
        uint32_t blockSize)
{
  ...
  memset(pState, 0, (maxDelay + blockSize) * sizeof(f32));
